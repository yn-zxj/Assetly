...
- JavaScript接口增强：新增shareTextAsFile方法用于文件分享功能
...
M["src-tauri/gen/android/app/src/main/java/com/assetly/home/MainActivity.kt<br/>Android 回退导航与WebView配置"] --> N["JavaScript 接口增强"]
...
- [src/routes/Settings.tsx:1-113](file://src/routes/Settings.tsx#L1-L113)
...
- **新增** JavaScript接口增强：通过WebAppInterface提供shareTextAsFile方法，支持将文本内容作为文件分享。
...
### JavaScript接口增强（文件分享）
- **新增** shareTextAsFile方法：通过WebAppInterface提供原生文件分享能力。
